...
df = pd.read_csv('C:\\Users\\Lenovo\\Documents\\GitHub\\ai-course\\FastFood-project\\FastFoodRestaurants.csv',quotechar='"', on_bad_lines='skip' )
...
price = df['longitude']
print("Accessing 'longitude' column:")
print(price.head())
print()

# Accessing multiple columns
selected_cols = df[['longitude', 'latitude', 'keys']]
...
# Note: Replace 'longitude', 'latitude', 'keys' with actual column names in your CSV if needed
