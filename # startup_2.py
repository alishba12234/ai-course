...
#  Read csv file startup_growth_investment_data

startup_growth_investment_data = pd.read_csv('startup_growth_investment_data.csv',delimiter=",",parse_dates=[14], date_format={'date_added': '%d-%m-%Y'})

print(startup_growth_investment_data)

print("startup_2 - data types" , startup_growth_investment_data.dtypes)

print("startup_2.info():   " , startup_growth_investment_data.info() )

# display the last three rows
print('Last three Rows:')
print(startup_growth_investment_data.tail(3))

# display the first three rows
print('First Three Rows:')
print(startup_growth_investment_data.head(3))
print()

#Summary of Statistics of startup_growth_investment_data using describe() method.
print("Summary of Statistics of startup_2 using describe() method", startup_growth_investment_data.describe())

#Counting the rows and columns in startup_growth_investment_data using shape(). It returns the no. of rows and columns enclosed in a tuple.
print("Counting the rows and columns in startup_2 using shape() : " ,startup_growth_investment_data .shape)
print()



# access the Name column
agency = startup_growth_investment_data['agency']
print("access the Name column: startup_2 : ")
print(agency)
print()

"""
0            startup growth investment
1            HealthTech
2            8,1349245127.85
3            2490393546.173328 
4            24
...
agency_agent = startup_growth_investment_data[['agency','agent']]
print("access multiple columns: startup_2 : ")
print(agency_agent)
print()
...
""""                           agency                    agent
0      startup_2               SaaS                        2                        
1      2781498219.93           8363214103.88975            36                         
2       UK                     2006                       105.52
...
# 
"""
Syntax               startup_growth_investment_data.loc[row_indexer, column_indexer]              startup_growth_investment_data.iloc[row_indexer, column_indexer]
