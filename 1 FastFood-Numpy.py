...
Address,City,Country,Longitude,latitude = np.genfromtxt('FastFoodRestaurants.csv', delimiter = ',',usecols=(0,3,4,5,6),dtype= None,skip_header=1, unpack=True, invalid_raise=False)
