...
Industry, FundingRounds , InvestmentAmount ,NumberofInvestors = np.genfromtxt('startup_growth data.csv', delimiter=',', usecols=(1,2,4,3), unpack=True, dtype=None,skip_header=1,invalid_raise=False)
