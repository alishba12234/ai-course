...
bed, price , zip_code , status = np.genfromtxt('C:\\Users\\Lenovo\\Documents\\GitHub\\ai-course\\RealEstate-project\\RealEstate-USA.csv', delimiter=',', usecols=(3,2,9,1), unpack=True, dtype=None,skip_header=1)
